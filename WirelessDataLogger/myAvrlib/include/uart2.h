...
#define UART0_DEFAULT_BAUD_RATE		19200UL //115200UL	///< default baud rate for UART0
#define UART1_DEFAULT_BAUD_RATE		19200UL		///< default baud rate for UART1

// buffer memory allocation defines
// buffer sizes
#ifndef UART0_TX_BUFFER_SIZE
#define UART0_TX_BUFFER_SIZE		0x0048	///< number of bytes for uart0 transmit buffer
#endif
#ifndef UART0_RX_BUFFER_SIZE
#define UART0_RX_BUFFER_SIZE		0x00FF	///< number of bytes for uart0 receive buffer
#endif
#ifndef UART1_TX_BUFFER_SIZE
#define UART1_TX_BUFFER_SIZE		0x0064	///< number of bytes for uart1 transmit buffer
#endif
#ifndef UART1_RX_BUFFER_SIZE
#define UART1_RX_BUFFER_SIZE		0x0032	///< number of bytes for uart1 receive buffer
#endif
...
//! Send string with null
void uartSendStr(u08 nUart, char *pStr) ;
