...
#define UARTSW_TX_PORT			PORTA	///< UART Transmit Port
#define UARTSW_TX_DDR			DDRA	///< UART Transmit DDR
#define UARTSW_TX_PIN			PA1		///< UART Transmit Pin

// UART receive pin defines
// This pin must correspond to the
// Timer1 Input Capture (ICP or IC1) pin for your processor
#define UARTSW_RX_PORT			PORTA	///< UART Receive Port
#define UARTSW_RX_DDR			DDRA	///< UART Receive DDR
#define UARTSW_RX_PORTIN		PINA	///< UART Receive Port Input
#define UARTSW_RX_PIN			PA1		///< UART Receive Pin
