...
/* Timer 0 */
#define TIMER0PRESCALER		1024UL		// TIMER0_CLK_DIV1024
#define TMR0_TARGET_FREQUENCY	20UL		// 20Hz = 50ms.
#define TIMER0RELOAD			(uint8_t)((F_CPU/TIMER0PRESCALER/TMR0_TARGET_FREQUENCY) - 1)
/* Timer 2 */
#define TIMER2PRESCALER			64UL		// TIMER2_CLK_DIV64
#define TMR2_TARGET_FREQUENCY	1000UL		// 1000Hz = 1ms.
#define TIMER2RELOAD			(uint8_t)((F_CPU/TIMER2PRESCALER/TMR2_TARGET_FREQUENCY) - 1)
...
void timer0StopTimer(void);					///< timer1 stop - reuben
void timer0StartTimer(void);				///< timer0 start - reuben
void timer1StopTimer(void);					///< timer1 stop - reuben
void timer1StartTimer(void);				///< timer1 start - reuben
#ifdef TCNT2	// support timer2 only if it exists
...
unsigned long timer0GetOverflowCount(void);		///< read timer0's overflow counter

#ifdef OCR0A	// for processors that support output compare on Timer0
void timer0CompareAInit( void(*tmr2UserFunc)(void) );
#endif
