...
#ifndef SCALE_CMDLINE_H
#define SCALE_CMDLINE_H
...
typedef struct{
	t_calibrationPoint Lowwer;
	t_calibrationPoint Upper;
	unsigned char	numPoints;
}t_scaleCalibrationPoint;
...
unsigned char cmdlineInputFunc(unsigned char c, unsigned char myFlag);
...
void getScaleCalibration(t_scaleCalibrationPoint * pScaleCalibrationPoint);
